...
JupyterLab is to add the code to use R kernels in JupyterLab and add a script to
start up the service.

The `IRkernel` package ^[@Kluyver2019] provides the R kernel interface code. And
the startup script is in `/home/edgyr/Scripts/start-jupyter-lab`.
